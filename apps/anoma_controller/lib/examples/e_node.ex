defmodule Anoma.Controller.Examples.EController do
  alias __MODULE__
  ...
  When a node is started, I put its EController struct in an ETS table for later retrieval.

  When a node is already spawned, I lookup the EController struct in the ETS table.
  ...
  """
  @spec start_node(Keyword.t()) ::
          EController.t() | {:error, :failed_to_start_node}
  ...
  """
  @spec stop_node(EController.t()) :: :ok
