defmodule Anoma.Client.Connection.GRPCProxy do
  ...
  @spec list_intents() :: {:ok, Protobufs.IntentPool.ListIntents.Response.t()}
  def list_intents() do
    GenServer.call(__MODULE__, {:list_intents})
  end

  @spec add_intent(Protobufs.Intent.t()) ::
          {:ok, Protobufs.IntentPool.AddIntent.Response.t()}
  def add_intent(intent) do
    GenServer.call(__MODULE__, {:add_intent, intent})
  end

  @spec list_nullifiers() :: {:ok, Protobufs.Indexer.Nullifiers.Response.t()}
