defmodule Anoma.LocalDomain.Examples.ELocalDomain.Intents do
  @moduledoc """
  ...
  def example_intent do
    Examples.ETransparent.ETransaction.nullify_intent()
  ...
  """
  @spec list_intents_empty :: ELocalDomain.t()
  ...
  """
  @spec add_intent(ELocalDomain.t()) :: {ELocalDomain.t(), String.t()}
  ...
  I add an intent to the client.
  """
  @spec list_intents_not_empty(ELocalDomain.t()) :: ELocalDomain.t()
