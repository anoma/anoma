defmodule Anoma.LocalDomain.Examples.ELocalDomain.Mempool do
  @moduledoc """
  ...
  """
  @spec add_transaction(ELocalDomain.t()) :: {ELocalDomain.t(), String.t()}
  ...
  """
  @spec add_transaction_faulty_nock(ELocalDomain.t()) :: ELocalDomain.t()
  ...
  """
  @spec add_transaction_no_transaction(ELocalDomain.t()) :: ELocalDomain.t()
