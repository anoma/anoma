defmodule Anoma.LocalDomain.Examples.ELocalDomain.Nock.Run do
  @moduledoc """
  I contain functions to test the public interface of the client.

  I show how to use the nock run and prove endpoints.
  """
  use Anoma.LocalDomain.Web.ConnCase
  use TypedStruct

  alias Anoma.LocalDomain.Examples.ELocalDomain

  import Anoma.LocalDomain.Examples.ELocalDomain
  import Anoma.LocalDomain.Examples.ELocalDomain.Nock
  import ExUnit.Assertions

  @doc """
  I run a simple nock program via the api.
  """
  @spec run_nock(ELocalDomain.t()) :: {ELocalDomain.t(), String.t()}
  ...
  """
  @spec run_nock_with_arg(ELocalDomain.t()) :: {ELocalDomain.t(), String.t()}
  ...
  """
  @spec run_nock_with_io(ELocalDomain.t()) :: {ELocalDomain.t(), String.t()}
  ...
  I run a siple nock program that is supposed to return some io.
  """
  @spec run_nock_error(ELocalDomain.t()) :: {ELocalDomain.t(), String.t()}
  ...
  I run a siple nock program that is supposed to return some io.
  """
  @spec run_nock_error_with_io(ELocalDomain.t()) ::
          {ELocalDomain.t(), String.t()}
