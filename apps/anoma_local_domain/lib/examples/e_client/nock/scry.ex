defmodule Anoma.LocalDomain.Examples.ELocalDomain.Nock.Scry do
  @moduledoc """
  ...
  @spec prove_with_internal_scry_call(ELocalDomain.t()) :: ELocalDomain.t()
  ...
  @spec prove_with_external_scry_call(ELocalDomain.t()) :: ELocalDomain.t()
  ...
  @spec prove_with_external_scry_call_nounify(ELocalDomain.t()) ::
          ELocalDomain.t()
