defmodule Anoma.LocalDomain.CLI do
  @moduledoc """
  ...
  def start_node(args) do
    case LocalDomain.connect(
      ...
      {:ok, _client} ->
        IO.puts(
          "Connected to node. Listening on #{Anoma.LocalDomain.Web.Endpoint.url()}"
        )
