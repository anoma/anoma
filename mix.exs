defmodule Anoma.MixProject do
  ...
  def group_for_modules() do
    [
      ...
      "Anoma Actors": [Anoma.Controller],
      Mempool: ~r/^Anoma.Controller.Mempool.?/,
      Executor: ~r/^Anoma.Controller.Executor.?/,
      Identity: [~r/^Anoma.Identity.?/, ~r/^Anoma.Controller.Identity.?/],
      Intents: ~r/^Anoma.Controller.Intent.?/,
      Storage: [
        ~r/^Anoma.Controller.Storage.?/,
        Anoma.Controller.Storage,
        Anoma.Order
      ],
      Transport: ~r/^Anoma.Controller.Transport.?/,
      Examples: ~r/^Examples.?/,
      "Cryptographic Primitives": [~r/^Anoma.Crypto.?/],
      Solver: [~r/^Anoma.Controller.Solver.?/],
      "General Engines": [~r/^Anoma.Controller.?/],
