defmodule Anoma.Cli do
  ...
  def argument_parser() do
    Optimus.new!(
      ...
      subcommands: [
        ...
        get: [
          name: "get",
          about: "Fetch the current value of the given key from the local node.",
          args: [
            key: [
              required: true,
              parser: :integer
  ...
  defp run_client_command(operation) do
    ...
    {:ok, _} = Anoma.Node.Router.start_engine(router, Anoma.Cli.Client, {router, transport, operation})
