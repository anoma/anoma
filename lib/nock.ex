defmodule Nock do
  ...
  @jet_registry %{
    6_149_546_978_850_415_302 => {"dec", 7, @layer_1_context_mug, &Nock.Jets.dec/1},
    13_456_140_584_432_748_094 => {"add", 7, @layer_1_context_mug, &Nock.Jets.add/1},
    14_801_825_384_048_474_882 => {"sub", 7, @layer_1_context_mug, &Nock.Jets.sub/1},
    16_448_669_966_680_839_947 => {"lth", 7, @layer_1_context_mug, &Nock.Jets.lth/1},
    9_593_574_083_496_825_465 => {"lte", 7, @layer_1_context_mug, &Nock.Jets.lte/1},
    1_289_252_054_839_247_911 => {"gth", 7, @layer_1_context_mug, &Nock.Jets.gth/1},
    11_860_242_327_310_494_912 => {"gte", 7, @layer_1_context_mug, &Nock.Jets.gte/1},
    1_648_022_014_956_696_243 => {"mul", 7, @layer_1_context_mug, &Nock.Jets.mul/1},
    9_385_224_608_484_213_408 => {"div", 7, @layer_1_context_mug, &Nock.Jets.div/1},
    9_865_107_020_110_751_778 => {"mod", 7, @layer_1_context_mug, &Nock.Jets.mod/1}
  }
    ...
    try do
      case formula do
        ...
        [6, cond | branches = [_true_branch | _false_branch]] ->
          ...
          {:ok, branch_formula} = nock(branches, [0 | crash_guard], jettedness)
