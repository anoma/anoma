...
use crate::types::address::{masp, Address, DecodeError, BECH32M_VARIANT};
...
pub struct OutputDescription {
    ...
    // TODO: c_enc: [u8;
    // masp_primitives::note_encryption::ENC_CIPHERTEXT_SIZE],
    pub c_enc: Vec<u8>,
    /// Encrypted note key recovery ciphertext
    // TODO: c_out: [u8;
    // masp_primitives::note_encryption::OUT_CIPHERTEXT_SIZE],
    pub c_out: Vec<u8>,
