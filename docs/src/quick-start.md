...
or on Mac:
```
$ curl -LO https://github.com/anoma/anoma/releases/download/v0.3.1/anoma-v0.3.0-Darwin-x86_64.tar.gz 
```
...
```shell
$ ./anomac utils join-network --chain-id=anoma-testnet-0.0.a1d4bbfafa49

➜ Downloading config release from https://github.com/heliaxdev/anoma-network-config/releases/download/anoma-testnet-0.0.a1d4bbfafa49/anoma-testnet-0.0.a1d4bbfafa49.tar.gz ...
➜ Successfully configured for chain ID anoma-testnet-0.0.a1d4bbfafa49
```
...
➜ Jan 06 22:22:19.864  INFO anoma_apps::cli::context: Chain ID: anoma-testnet-0.0.a1d4bbfafa49
...
```shell
$ ./anomac transfer --source faucet --target example-established --token XAN --amount 1000 --

➜ signer example-established
➜ Jan 06 22:24:32.926  INFO anoma_apps::cli::context: Chain ID: anoma-testnet-0.0.a1d4bbfafa49
...
➜  Jan 06 22:26:29.927  INFO anoma_apps::cli::context: Chain ID: anoma-testnet-0.0.a1d4bbfafa49
Generating validator account key...
```

You will be asked to enter an encryption password to generate a consensus key and a staking reward account key. After entering an encryption and decryption password, the transaction should be added to the mempool .
...
➜  Jan 06 22:28:17.624  INFO anoma_apps::cli::context: Chain ID: anoma-testnet-0.0.a1d4bbfafa49
Looking-up public key of atest1v4ehgw36ggmyzwp5g9prgsekgsu5y32z8ycnsvpeggcnys35gv65yvzxg3zrjwphgcu5gde4lvmstw from the ledger...
Enter decryption password: 
...
➜ Jan 06 22:29:08.903  INFO anoma_apps::cli::context: Chain ID: anoma-testnet-0.0.a1d4bbfafa49
...
➜ Jan 06 22:30:42.798  INFO anoma_apps::cli::context: Chain ID: anoma-testnet-0.0.a1d4bbfafa49
...
➜ Jan 06 22:31:24.908  INFO anoma_apps::cli::context: Chain ID: anoma-testnet-0.0.a1d4bbfafa49
